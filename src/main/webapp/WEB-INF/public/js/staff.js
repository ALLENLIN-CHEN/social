...
function setMap2(obj){
	var geoCoordMap = {
		    '上海': [121.4648,31.2891],
		    '东莞': [113.8953,22.901],
		    '东营': [118.7073,37.5513],
		    '广东省-中山市': [113.4229,22.478],
		    '临汾': [111.4783,36.1615],
		    '临沂': [118.3118,35.2936],
		    '丹东': [124.541,40.4242],
		    '丽水': [119.5642,28.1854],
		    ...
		    '青岛': [120.4651,36.3373],
		    '韶关': [113.7964,24.7028],
		    '广东省-深圳市':[114.0666,22.6166],
		    '广东省-珠海市':[113.5200,22.3150],
		    '广东省-佛山市':[113.1100,23.0500],
		    '湖北省-十堰市':[110.7900,32.6500],
		    '湖北省-咸宁市':[114.2800,29.8700],
		    '湖北省-孝感市':[113.9100,31.9200],
		    '湖北省-宜昌市':[111.3000,30.7010],
		    '湖北省-武汉市':[114.3100,30.5200],
		    '湖北省-荆州市':[112.2312,30.3300],
		    '湖北省-荆门市':[112.1900,31.0200],
		    '湖北省-襄樊市':[112.1700,30.0200],
		    '湖北省-鄂州市':[114.8700,30.4400],
		    '湖北省-随州市':[113.3701,37.7212],
		    '湖北省-黄冈市':[114.8700,30.4413],
		    '湖北省-黄石市':[115.0301,30.2568]
	...
	function showCity(cityData) {
		...
		option = {
			...
			geo: {  //地图数据设置（颜色，位置，大小,中心点等）
				...
				left: '10',
				right: '35%',
				center: [107.98561551896913, 35.205000490896193],
				zoom: 0.9,
				label: {
					emphasis: {
						show: false
